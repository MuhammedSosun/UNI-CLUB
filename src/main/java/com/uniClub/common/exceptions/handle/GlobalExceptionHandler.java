...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError<?>> handleBaseException(BaseException ex, WebRequest request) {
        return ResponseEntity.badRequest().body(createApiError(ex.getErrorMessage(),request));
    }
    ...
    public ResponseEntity<ApiError<Map<String, List<String>>>> handleException(MethodArgumentNotValidException ex, WebRequest request) {
